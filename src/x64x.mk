...
FC=ifx
CPUFLAGS=-DUSE_INTEL -DUSE_X64 -fPIC -fexceptions -fasynchronous-unwind-tables -fno-omit-frame-pointer -mprefer-vector-width=512 -qopenmp -vec-threshold0 -rdynamic -static-libgcc
ifdef KIND_SINGLE
